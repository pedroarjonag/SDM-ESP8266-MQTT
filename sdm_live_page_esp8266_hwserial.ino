...
SDM sdm(Serial, 2400, 14, SERIAL_8N1, false);                            //HARDWARE SERIAL
...
const char* wifi_ssid = "NETMAPE";
const char* wifi_password = "mape7493";
...
void sdmRead() {
  ...
  for (uint8_t i = 0; i < NBREG; i++) {
    tmpval = sdm.readVal(sdmarr[i].regarr,0x01);
